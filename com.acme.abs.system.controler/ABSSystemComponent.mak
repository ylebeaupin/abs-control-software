...
FLAGSFILE=
RULESFILE=
OMROOT="D:\Program Files\IBM\Rational\Rhapsody\8.1.4\Share"
RHPROOT="D:\Program Files\IBM\Rational\Rhapsody\8.1.4"
...
TARGET_NAME=ABSSystemComponent

all : $(TARGET_NAME)$(EXE_EXT) ABSSystemComponent.mak

TARGET_MAIN=MainABSSystemComponent
...
ABSSystem.obj : ABSSystem.cpp ABSSystem.h    
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"ABSSystem.obj" "ABSSystem.cpp" 
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) ABSSystemComponent.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) ABSSystemComponent.mak
	@echo Building library $@
	$(LIB_CMD) $(LIB_FLAGS) /out:$(TARGET_NAME)$(LIB_EXT) $(OBJS) $(ADDITIONAL_OBJS) $(LIBS)

clean:
	@echo Cleanup
	if exist ABSSystem.obj erase ABSSystem.obj
